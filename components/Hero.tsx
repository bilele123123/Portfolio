  ...
  return (
    <div className="h-screen w-full bg-black-100 relative flex flex-col items-center justify-center antialiased">
      <div className="max-w-2xl mx-auto p-4 relative z-20">
        ...
        <h1 className="relative z-10 text-lg md:text-5xl bg-clip-text text-neutral-300 font-bold">
          Thai Le
        </h1>
        <p></p>
        <p className="text-neutral-400 max-w-lg mx-auto my-2 text-xl relative z-10">
          I love to bicycle, powerlift, binge web comics and spending time with
        ...
        >
          <button className="text-neutral-300 bg-black-200 px-6 py-2 rounded-xl uppercase font-medium hover:bg-black-500 hover:font-bold relative z-20">
            Resume
          </button>
        </a>
      </div>
