    ...
    <section id="hero" className="hero-section">
      ...
      <div className="h-screen w-full bg-black-100 relative flex flex-col items-center justify-center antialiased">
        <div className="max-w-2xl mx-auto p-4 relative z-20">
          <p className="uppercase tracking-widest text-x text-neutral-400 max-w-80 pb-4">
            always keep your smile 😊
          </p>
          <h1 className="relative z-10 text-lg md:text-5xl bg-clip-text text-white font-bold pb-4">
            Thai Le
          </h1>
          <p></p>
          <p className="text-neutral-400 max-w-lg mx-auto my-2 text-xl relative z-10 pb-4">
