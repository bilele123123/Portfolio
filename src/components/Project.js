...
function Project() {
    return (
        <div className="main-body" id="project">

            <div className="project-container">
                <div className="project mb-10">
                    <h1 className="text-center text-4xl text-custom-ffffff m-5 mb-8 font-bold">Project</h1>

                    <div className="project-content-main flex flex-col items-center">
                        <div className="skills">
                            <div className="skills-carousel">
                                <i class='bx-icons bx bxl-react'></i>
                                <i class='bx-icons bx bxl-java' ></i>
                                <i class='bx-icons bx bxl-javascript' ></i>
                                <i class='bx-icons bx bxl-nodejs' ></i>
                                <i class='bx-icons bx bxl-mongodb' ></i>
                                <i class='bx-icons bx bxl-css3' ></i>
                                <i class='bx-icons bx bxl-html5' ></i>
                                <i class='bx-icons bx bxl-typescript' ></i>
                                <i class='bx-icons bx bxl-github' ></i>
                            </div>
                            <div className="skills-carousel">
                                <i class='bx-icons bx bxl-react'></i>
                                <i class='bx-icons bx bxl-java' ></i>
                        ...
                        <div className="project-card-container">
                            ...
                            <div className="card-row">
                                <div className="project-card">
                                    <a target="_blank" rel="noreferrer noopener" href="https://github.com/bilele123123/inventory-application">
                                        <img alt="inventory-application" src="https://github.com/bilele123123/inventory-application/raw/master/assets/website_preview.gif"></img>
                                        <div className="card-content p-3">
                                            <p className="text-xl font-bold pb-1">Inventory Management System</p>
                                            <p>A full-stack application designed to streamline inventory tracking and management processes.
                                                It provides a user-friendly interface for adding, updating, and managing various types of products within an inventory. </p>
                                        </div>
                                    </a>
                                </div>
                                    ...
                                    <a href="https://github.com/bilele123123/mini-message-board" rel="noreferrer noopener" target="_blank">
                                        ...
                                        <div className="card-content p-3">
                                            ...
                                            <p>The Mini Message Board is a simple web application that allows users to view and post messages on a public message board.
                                                Users can add their own messages, which are then displayed on the website for others to see.</p>
                                        </div>
                                    </a>
                                </div>
                                    ...
                                    <a href="https://bilele123123.github.io/memory-card/" rel="noreferrer noopener" target="_blank">
                                        ...
                                        <div className="card-content p-3">
                                            ...
                                            <p>A web-based memory card game that test and challenge your memory skills.
                                                Your objective is to avoid clicking on the same card.</p>
                                        </div>
                                    ...
                                    <a href="https://bilele123123.github.io/Etch-a-Sketch/" rel="noreferrer noopener" target="_blank">
                                        ...
                                        <div className="card-content p-3">
                                            ...
                                            <p>A fun web-based drawing application that functions similar to the Etch-a-Sketch toy.
                                                It features multi-coloring tool, shading, eraser, resizing the canvas as well as clear canvas.</p>
                                        </div>
                                    </a>
                                </div>
